...
This audit was generated by the `seo-geo-audit` Claude skill. Each check is a piece of semantic reasoning over the source code, not a regex match. The audit is read-only — to apply fixes, run `/audit fix`.
